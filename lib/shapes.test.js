...
describe("Circle", () => {
  describe("render", () => {
    it("should render a pink svg circle with 'aaa' inside, written in purple", () => {
      ...
      shape.setColor("pink");
      expect(shape.render("purple", "aaa")).toEqual(generatedCircle);
    });
  });
});
...
describe("Square", () => {
  describe("render", () => {
    it("should render a green svg square with 'bbb' inside, written in blue", () => {
      ...
      expect(shape.render("blue", "bbb")).toEqual(generatedSquare);
    });
  });
});
...
describe("Triangle", () => {
  describe("render", () => {
    it("should render a black svg triangle with 'ccc' inside, written in white", () => {
      ...
      expect(shape.render("white", "ccc")).toEqual(generatedTriangle);
    });
  });
});
